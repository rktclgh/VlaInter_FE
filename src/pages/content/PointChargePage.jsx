    ...
    <div className="min-h-screen bg-white pt-[54px]">
      ...
      <div className="flex min-h-[calc(100vh-54px)]">
        ...
        <main className="flex min-w-0 flex-1 flex-col">
          <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-5 md:px-8 md:py-10">
            <div className="mx-auto w-full max-w-[680px] rounded-[16px] border border-[#e1e1e1] bg-white p-6 text-center">
              <h1 className="text-[24px] font-semibold text-[#1f1f1f] sm:text-[28px]">포인트 충전</h1>
              <p className="mt-3 text-[13px] text-[#666] sm:text-[14px]">
                포인트 충전 페이지는 곧 연결될 예정입니다.
              </p>
              <button
                type="button"
