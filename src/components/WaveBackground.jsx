...
const shimmerLines = [
  {
    ...
    gradient: "linear-gradient(90deg, rgba(93,131,222,0), rgba(93,131,222,0.92), rgba(93,131,222,0))",
  ...
  },
  {
    ...
    gradient: "linear-gradient(90deg, rgba(255,28,145,0), rgba(255,28,145,0.96), rgba(255,28,145,0))",
...
export const WaveBackground = () => {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden bg-[#050816]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(23,38,96,0.56),rgba(5,8,22,0.92)_38%,#03040b_100%)]" />
      <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(4,8,26,0.04)_0%,rgba(4,8,26,0.14)_40%,rgba(4,8,26,0.78)_100%)]" />

      <MotionDiv
        className="absolute left-[-12%] top-[18%] h-[18rem] w-[18rem] rounded-full bg-[#365bff]/20 blur-[7rem] md:h-[24rem] md:w-[24rem]"
        animate={{ x: [0, 18, 0], y: [0, -12, 0], scale: [1, 1.08, 1] }}
        transition={{ duration: 11, repeat: Infinity, ease: "easeInOut" }}
      />
      <MotionDiv
        className="absolute right-[-10%] top-[16%] h-[20rem] w-[20rem] rounded-full bg-[#ff1c91]/16 blur-[7rem] md:h-[27rem] md:w-[27rem]"
        animate={{ x: [0, -18, 0], y: [0, 16, 0], scale: [1, 1.06, 1] }}
        transition={{ duration: 13, repeat: Infinity, ease: "easeInOut" }}
      />
      <MotionDiv
        className="absolute left-[32%] top-[30%] h-[10rem] w-[18rem] rounded-full bg-[#6d56ff]/14 blur-[5rem]"
